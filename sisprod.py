...
# Menampilkan judul di halaman web Streamlit
st.title("Sistem Produksi: Analisis Penjadwalan STR")
st.write("Aplikasi simulasi penjadwalan menggunakan metode **Slack Time Remaining (STR)**.")
...
# Menampilkan tabel hasil di halaman Streamlit
df_solusi = pd.DataFrame(solved_details)
st.subheader("Tabel Hasil Urutan Penjadwalan")
st.dataframe(df_solusi, use_container_width=True)

# =====================================================================
# 3. VISUALISASI GANTT CHART (Menggunakan st.pyplot)
# =====================================================================
st.subheader("Visualisasi Time-Phased Flow")
...
# Perubahan Utama: Gunakan st.pyplot untuk melempar grafik ke interface Streamlit
st.pyplot(fig)
